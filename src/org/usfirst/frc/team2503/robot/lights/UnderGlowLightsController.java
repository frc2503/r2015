...
public class UnderGlowLightsController implements LightsController {
	public enum UnderGlowLightsControllerStatus {
		OFF(0),
		ON(1),
		...
		private UnderGlowLightsControllerStatus(final int value) {
			this.value = value;
		}
	...
	private Relay relay;
	private UnderGlowLightsControllerStatus status;
	...
	public void setStatus(UnderGlowLightsControllerStatus status) {
		this.status = status;
	}
	...
	public UnderGlowLightsController(Relay relay) {
		this.relay = relay;
	}
}